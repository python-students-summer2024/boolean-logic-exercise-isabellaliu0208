...
def is_sweltering():
    ...
    """
    temperature = int(input("What's the current temperature? (in Farenheit)"))
    if temperature > 90:
      return True
    else:
      return False
...
def is_warm():
    ...
    """
    temperature2 = int(input("What's the current temperature? (in Farenheit)"))
    if temperature2 <= 87 and temperature2 >= 75:
        return True
    else:
        return False
...
def is_humid():
    ...
    """
    ishumid = input("Is it humid today? (enter yes/no)")
    if ishumid == "yes":
        return True
    else:
        return False
...
def is_inclement():
    ...
    """
    wheather = input("What is the weather forecast today?")
    if wheather in {"rain", "snow", "sleet"}:
        return True
    else:
        return False
